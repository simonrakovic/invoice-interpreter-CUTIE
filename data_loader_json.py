...
class DataLoader():
    ...
    """
    def __init__(self, params, update_dict=True, load_dictionary=False, data_split=1):
        self.random = False
        self.data_laundry = False
        self.encoding_factor = 1# ensures the size (rows/cols) of grid table compat with the network
        self.classes = ['0', 'DATE_SALE', 'DOC_NR', 'DATE_CREATION', 'VAT_ID_CONTRACTOR',
                        'TOTAL_PAY', 'TOTAL_TAX', 'TOTAL_WITHOUT_TAX', 'DATE_PAYMENT']
    ...
    def _get_filenames(self, data_path):
        ...
        for dirpath,dirnames,filenames in walk(data_path):
            ...
            for filename in filenames:
                ...
                if file.endswith('csv') or file.endswith('modeled'):
                    files.append(file)
        return files       
