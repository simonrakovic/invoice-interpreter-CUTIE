...
parser.add_argument('--save_prefix', type=str, default='SROIE', help='prefix for ckpt') # TBD: save logs/models with prefix
...
parser.add_argument('--ckpt_path', type=str, default='graphs/')
